...
obj/user/overflowhello:	file format elf64-x86-64
...
; 	puts(s, 0x800000000000);
  800044: 48 8d 3d bf 0f 00 00         	leaq	4031(%rip), %rdi        # 0x80100a <syscall.c+0x80100a>
  80004b: 48 be 00 00 00 00 00 80 00 00	movabsq	$140737488355328, %rsi  # imm = 0x800000000000
; 	puts(s, 0x800000000000);
  800055: e8 46 00 00 00               	callq	0x8000a0 <puts>
; }
