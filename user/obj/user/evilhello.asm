...
; {
  ...
  800044: 48 bf 00 00 10 00 00 80 ff ff	movabsq	$-140737487306752, %rdi # imm = 0xFFFF800000100000
; 	puts((char*)0xffff800000100000, 100);
  80004e: be 64 00 00 00               	movl	$100, %esi
  800053: e8 48 00 00 00               	callq	0x8000a0 <puts>
; }
  800058: 31 c0                        	xorl	%eax, %eax
  80005a: 5d                           	popq	%rbp
  80005b: c3                           	retq
  80005c: cc                           	int3
  80005d: cc                           	int3
