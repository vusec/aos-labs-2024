...
obj/user/kernelwrite:	file format elf64-x86-64
...
; {
  ...
  800044: 48 b8 00 00 10 00 00 80 ff ff	movabsq	$-140737487306752, %rax # imm = 0xFFFF800000100000
; 	*(volatile char *)0xffff800000100000 = 42;
  80004e: c6 00 2a                     	movb	$42, (%rax)
; 	return 0;
  800051: 31 c0                        	xorl	%eax, %eax
  800053: 5d                           	popq	%rbp
  800054: c3                           	retq
  800055: cc                           	int3
  800056: cc                           	int3
